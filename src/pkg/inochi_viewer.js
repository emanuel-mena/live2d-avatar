/* @ts-self-types="./inochi_viewer.d.ts" */

export class InochiViewer {
    __destroy_into_raw() {
        const ptr = this.__wbg_ptr;
        this.__wbg_ptr = 0;
        InochiViewerFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_inochiviewer_free(ptr, 0);
    }
    /**
     * @returns {number}
     */
    get_camera_x() {
        const ret = wasm.inochiviewer_get_camera_x(this.__wbg_ptr);
        return ret;
    }
    /**
     * @returns {number}
     */
    get_camera_y() {
        const ret = wasm.inochiviewer_get_camera_y(this.__wbg_ptr);
        return ret;
    }
    /**
     * @returns {string}
    ...
    get_params_json() {
        ...
        let deferred1_1;
        try {
            const ret = wasm.inochiviewer_get_params_json(this.__wbg_ptr);
            deferred1_0 = ret[0];
            deferred1_1 = ret[1];
     ...
     */
    get_zoom() {
        const ret = wasm.inochiviewer_get_zoom(this.__wbg_ptr);
        return ret;
    }
    /**
     ...
     */
    constructor(canvas_id, model_data) {
        const ptr0 = passStringToWasm0(canvas_id, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passArray8ToWasm0(model_data, wasm.__wbindgen_malloc);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.inochiviewer_new(ptr0, len0, ptr1, len1);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        this.__wbg_ptr = ret[0] >>> 0;
        InochiViewerFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
     ...
     */
    render(timestamp) {
        wasm.inochiviewer_render(this.__wbg_ptr, timestamp);
    }
    /**
     * @param {number} width
     * @param {number} height
     */
    resize(width, height) {
        wasm.inochiviewer_resize(this.__wbg_ptr, width, height);
    }
    /**
     * @param {number} x
     * @param {number} y
    ...
    set_param(name, x, y) {
        ...
        const len0 = WASM_VECTOR_LEN;
        wasm.inochiviewer_set_param(this.__wbg_ptr, ptr0, len0, x, y);
    }
    /**
     * @param {number} x
     * @param {number} y
     */
    set_position(x, y) {
        wasm.inochiviewer_set_position(this.__wbg_ptr, x, y);
    }
    /**
     * @param {number} radians
     */
    set_rotation(radians) {
        wasm.inochiviewer_set_rotation(this.__wbg_ptr, radians);
    }
    /**
     * @param {number} zoom
     */
    set_zoom(zoom) {
        wasm.inochiviewer_set_zoom(this.__wbg_ptr, zoom);
    }
}
if (Symbol.dispose) InochiViewer.prototype[Symbol.dispose] = InochiViewer.prototype.free;
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./inochi_viewer_bg.js": import0,
    };
}

const InochiViewerFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_inochiviewer_free(ptr >>> 0, 1));
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('inochi_viewer_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
